...
gSounds = {
    ...
    ['music2'] = love.audio.newSource('sounds/audio2.mp3'),
...
-----------------------------------------------------------  
    ['background'] = love.graphics.newImage('graphics/nightSky.png'),
    ['particle'] = love.graphics.newImage('graphics/shiny_particle.png')
-----------------------------------------------------------
}
